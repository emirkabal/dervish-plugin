...
public class CustomItem {
    ...
    public static ItemStack getArrow() {
        ItemStack arrow = CustomItem.of(Material.ARROW).withName("§lEmax:§r I hate this.").get();
        return arrow;
    }
    public static ItemStack getArrow(int amount) {
        ItemStack arrow = CustomItem.of(Material.ARROW, amount).withName("§lEmax:§r I hate this.").get();
        return arrow;
    }
